...
def parse_seg_args():
    ...
    # data
    parser.add_argument('--dataset', type=str, default='BraTS2021_Training_Data', help='dataset hint',
        choices=['BraTS2021', 'brats2018'])
    parser.add_argument('--data_root', type=str, default='E:/study_code/智能体项目/BraTS2021数据/', help='root dir of dataset')
    parser.add_argument('--cases_split', type=str,default= './data/split/brats2021_split_fold0.csv',help='name & split')
    ...
    parser.add_argument('--ds_layer', type=int, default=3,
